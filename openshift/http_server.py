#!/usr/bin/env python3
"""
HTTP Server for Customer JIRA Tracker
Runs on OpenShift as a REST API service
"""
...
app = FastAPI(
    title="Customer JIRA Tracker API",
    description="REST API for tracking JIRA tickets by customer",
    version="1.0.0"
)

# Configuration
STORAGE_DIR = os.getenv("CUSTOMER_JIRA_STORAGE", "/data")
REQUIRE_AUTH = os.getenv("REQUIRE_AUTH", "false").lower() == "true"
API_KEY = os.getenv("CUSTOMER_JIRA_API_KEY", "")
